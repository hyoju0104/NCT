...
VALUES (3, 'admin', '$2a$10$.JN4oKC7Nr6oR8NgYxX3fOvtAn3OOURyYPNDf4Y/E5hfWKhblkKfe', '관리자', 0, 'ACTIVE', 'ACTIVE'),
       ...
       (1, 'user2', '$2a$10$5e2fLl7OQKtTpGQyIlvbMuI8.eyKlVu1qfRuHlC/QyIcLvdPgh48O', '회원2', 0, 'ACTIVE', 'ACTIVE'),
...
VALUES (4, 3, 100000, '2024-12-10'),
       (3, 2, 70000, '2025-1-2'),
       (4, 3, 100000, '2025-1-10'),
       (3, 2, 70000, '2025-2-2'),
       (4, 3, 100000, '2025-2-10'),
       (3, 2, 70000, '2025-3-2'),
       (4, 3, 100000, '2025-3-10'),
       (3, 2, 70000, '2025-4-2'),
       (4, 3, 100000, '2025-4-10'),
       (2, 1, 50000, '2025-4-25'),
       (3, 2, 70000, '2025-5-2')
;
